<footer class="footer">
    <div class="footer__grid">
        <div class="footer__contenido">
            ...
            <p class="footer__texto">
                DevWebCamp es una conferencia para desarrolladores de todo los niveles, se lleva a cabo de forma presensial y en linea.
            </p>
        </div>
    ...
    <p class="footer__copy">
        ...
        <span class="footer__copy--regular">
            - Todo los derechos reservados <?php echo date('Y'); ?>
        </span>
    </p>
</footer>
